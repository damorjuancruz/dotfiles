...
IgnorePackage awesome-terminal-fonts         # fonts/icons for powerlines
...
IgnorePackage bluez-hid2hci                  # Put HID proxying bluetooth HCI's into HCI mode
IgnorePackage bluez-libs                     # Deprecated libraries for the bluetooth protocol stack
...
IgnorePackage lib32-mesa                     # Open-source OpenGL drivers - 32-bit
IgnorePackage lib32-opencl-mesa              # Open-source OpenCL drivers - 32-bit
...
IgnorePackage networkmanager-openvpn         # NetworkManager VPN plugin for OpenVPN (with GUI)
...
IgnorePackage noto-fonts                     # Google Noto TTF fonts
IgnorePackage noto-fonts-cjk                 # Google Noto CJK fonts
IgnorePackage noto-fonts-emoji               # Google Noto Color Emoji font
IgnorePackage nss-mdns                       # glibc plugin providing host name resolution via mDNS
IgnorePackage opencl-mesa                    # Open-source OpenCL drivers
...
IgnorePackage perl                           # A highly capable, feature-rich programming language
...
IgnorePackage ttf-bitstream-vera             # Bitstream Vera fonts.
IgnorePackage ttf-dejavu                     # Font family based on the Bitstream Vera Fonts with a wider range of characters
IgnorePackage ttf-liberation                 # Font family which aims at metric compatibility with Arial, Times New Roman, and Courier New
IgnorePackage ttf-meslo-nerd                 # Patched font Meslo LG from nerd fonts library
IgnorePackage ttf-opensans                   # Sans-serif typeface commissioned by Google
IgnorePackage ufw                            # Uncomplicated and easy to use CLI tool for managing a netfilter firewall
IgnorePackage unrar                          # The RAR uncompression program
IgnorePackage unzip                          # For extracting and viewing files in .zip archives
...
IgnorePackage vlc-plugins-all                # Free and open source cross-platform multimedia player and framework - all plugins
